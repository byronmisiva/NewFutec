...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 18273, function(sym, e) {
         // insert code here
      });
      //Edge binding end

      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 16871, function(sym, e) {
         // insert code here
         sym.stop();
...
})(window.jQuery || AdobeEdge.$, AdobeEdge, "EDGE-11811655");
