...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
	...
	$("#Stage_contenedor_Rectangle").html("");

      });
      //Edge binding end
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 9588, function(sym, e) {
         // insert code here
         // Pause a video track 
         sym.$("video")[0].pause();
      });
      ...
      Symbol.bindElementAction(compId, symbolName, "document", "compositionReady", function(sym, e) {
         ...
         youtube.attr('src','https://www.youtube.com/watch?v=zCT0mHuXN90'); 
