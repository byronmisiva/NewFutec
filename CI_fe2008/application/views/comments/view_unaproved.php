<div id="admin">
	...
	<th></th>
	 ...
	 <tr>
	 <td colspan='4' style='font-size: 12px; color: gray;'><?=$row->title?></td>
	 </tr>
	 <tr class='altrow'>
	 ...
	 <td class="actions">
	 <?=anchor('comments/aprove/'.$row->id, img(array('src'=>'imagenes/icons/accept.png','border'=>'0')), array('title' => 'Aprobar'));?>
