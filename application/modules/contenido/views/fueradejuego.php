...
<div class="col-md-12 separador10-xs margen0r">
    ...
    <div class="  ">
        <div class="linksFueraJuego separador10 col-md-12 center-block text-center">
            <div class="contenlinksFueraJuego">
                ...
                <link type="text/css" rel="stylesheet"
                      href="<?= base_url('assets/css/fueradejuego/fueradejuego.css') ?>"/>
            </div>
        </div>
...
{ ?>
    <div class="containerfueradejuego separador10 col-md-12 margen0 galeria<?php echo $galeria; ?>content">
        <div class="liquid-slider" id="main-slider<?php echo $galeria; ?>">
            <?php for ($i = 1; $i <= $total; $i++) { ?>
                <div class="">
                    <h2 class="title hidden">
                        <div class="thum-fuera"><img class="main-slider<?php echo $galeria; ?>-img img-responsive lazo"
                                                     data-original="<?= base_url() ?>imagenes/galerias-fuera-de-juego/galeria<?php echo $galeria; ?>/<?php echo $i; ?>b.jpg"
                                                     alt=" "/></div>
                    </h2>
                    <img class="img-responsive lazo <?php if ($i == 1 ) echo 'imagen1a';?> " id="<?php if ($i == 1 ) echo 'imagen' . $galeria; ?>"
    ...
    <div class="containerfueradejuego separador10 col-md-12 margen0 galeria<?php echo $galeria; ?>content">
        <div class="liquid-slider" id="main-slider<?php echo $galeria; ?>">
            <?php for ($i = 1; $i <= $total; $i++) { ?>
                <div class="">
                    <h2 class="title hidden">
                        <div class="thum-fuera"><img class="main-slider<?php echo $galeria; ?>-img img-responsive"
                                                     src="<?= base_url() ?>imagenes/galerias-fuera-de-juego/galeria<?php echo $galeria; ?>/<?php echo $i; ?>b.jpg"
                                                     alt=" "/></div>
                    </h2>
                    <img class="img-responsive <?php if ($i == 1 ) echo 'imagen1a'; ?>" id="<?php if ($i == 1 ) echo 'imagen' . $galeria; ?>"
