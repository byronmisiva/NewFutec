                    ...
                    <div class="  text-white">
                        <div class="col-md-12 col-sm-12 margen0l margen0r   h5">
                            ...
                            <div class="col-md-8 col-sm-8 margen0 h5">
                                ...
                                <div class="col-md-5 col-sm-5 margen0 h5 text-right  ">
                                    <?php echo $score->hsname; ?>
                                </div>
                                <div class="col-md-2 col-sm-2 margen0 h5  text-center text-marcador-home">
                                    <?php
                                    //echo str_replace(' ', '', $score->result);
                                    echo   $score->result ; ?>
                                </div>
                                <div class="col-md-5 col-sm-5 margen0 h5 text-left  ">
                        ...
                        <div class="col-md-5 col-md-offset-1 col-sm-5 col-sm-offset-1 h6 text-blue1 margen0">
