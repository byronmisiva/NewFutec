<div id="carousel-marcadorenvivo" class="carousel slide marcadorenvivofondo" data-ride="carousel">
    <div class="carousel-inner">
        ...
        foreach ($scores as $score) {
            ...
            $active = ""; ?>">
                <a href="<?= base_url() ?>site/partido/<?php echo  $this->contenido->_urlFriendly($score->hname) . "-" . $this->contenido->_urlFriendly($score->aname) . "/" . $score->id; ?>">
                    <div class="  text-white">
                        <div class="col-md-12 col-sm-12 col-xs-12 margen0l margen0r   h5">
                            ...
                            <div class="col-md-8 col-sm-8 col-xs-8 margen0 h5">
                                ...
                                <div class="col-md-2 col-sm-2 col-xs-2 margen0 h5  text-center text-marcador-home">
                                    <?php
                        ...
                        <div class="col-md-5 col-md-offset-1 col-sm-5 col-xs-5 col-sm-offset-1 h6 text-blue1 margen0">
