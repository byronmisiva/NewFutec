...
<!-- Banner desplegable el mismo que anteriormente estaba en el smart-top -->
<div  class="desplegable-alertas col-md-12 col-xs-12 col-sm-12  margen0">
    <div  class="desplegable-alertas-conten  ">
        <div class=" margen0 despimglogo">
            <img class="img-responsive" src="<?php echo base_url(); ?>imagenes/febanners/images_desplegable_alertas/icono.png">
        </div>
        <div class="   margen0 despimglogo2">
            <a target="_blank" href="https://itunes.apple.com/app/id1008177383"
               onclick="ga('send', 'event', 'btn-ios','click','push');">
               <img class="img-responsive" src="<?php echo base_url(); ?>imagenes/febanners/images_desplegable_alertas/icono_1.png">
             </a>
        </div>
        <div class="   margen0 despimglogo2">
            <a target="_blank"
               href="https://play.google.com/store/apps/details?id=com.misiva.futbolecuadorpush"
               onclick="ga('send', 'event', 'btn-android','click','push');">
               <img class="img-responsive" src="<?php echo base_url(); ?>imagenes/febanners/images_desplegable_alertas/icono_2.png">
             </a>
        </div>
    </div>
</div>
