...
.introFE{
	...
	.deviceFE{		
		background-image: url('<?php echo base_url().'imagenes/introFEmagazine/dispositivos.png?frefresh=9687987'?>');
	...
	if(typeof wabtn4fg==="undefined"){
		...
		s.src="<?php echo base_url()?>js/whatsapp/whatsapp-button.js";h.appendChild(s);}</script>
