                    ...
                    <tr>
                        ...
                        <td><select name="year">
                                <?php for ($i = 2000; $i <= mdate("%Y", time()) + 1; $i += 1) { ?>
                                    <option
                                    value="<?php echo $i ?>" <?php if ($row->year == $i) echo " SELECTED " ?>><?php echo $i ?></option><?php } ?>
                            </select></td>
                    </tr>
                    <tr>
                        <td>Ronda Activa:
                        ...
                        <td><select name="active_round">
                                ...
                                <?php foreach ($rnds->result() as $rou): ?>
                                    <option value= <?= '"' . $rou->id . '"';
                                    if ($row->active_round == $rou->id) echo "SELECTED"; ?>><?= $rou->name ?></option>
                                <?php endforeach; ?>
                            </select></td>
                    </tr>
                    <tr>
                        ...
                        <td><select name="active_championship">
                                <option value="0" <?php if ($row->active_championship == 0) echo " SELECTED " ?>>No</option>
                                <option value="1" <?php if ($row->active_championship == 1) echo " SELECTED " ?>>Si</option>
                            </select></td>
                    </tr>
                </table>
            </td>
