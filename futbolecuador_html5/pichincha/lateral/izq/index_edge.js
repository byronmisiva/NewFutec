                    ...
                    dom: [
                        {
                            id: 'fondo',
                            type: 'image',
                            rect: ['40px', '0px', '120px', '600px', 'auto', 'auto'],
                            opacity: '0',
                        ...
                        },
                        {
                            id: 'jugador1_15',
                            type: 'image',
                            rect: ['40px', '194px', '120px', '406px', 'auto', 'auto'],
                            opacity: '0',
                        ...
                        },
                        {
                            id: 'logo_01',
                            type: 'image',
                            rect: ['40px', '0px', '120px', '47px', 'auto', 'auto'],
                            fill: ["rgba(0,0,0,0)",im+"logo_01.jpg",'0px','0px']
                        },
                        {
                            id: 'juagador2_02',
                            type: 'image',
                            rect: ['40px', '180px', '120px', '307px', 'auto', 'auto'],
                            opacity: '0',
                        ...
                        },
                        {
                            id: 'Rectangle',
                            type: 'rect',
                            rect: ['40px', '487px', '120px', '113px', 'auto', 'auto'],
