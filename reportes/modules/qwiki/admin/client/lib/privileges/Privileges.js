...
QoDesk.QoAdmin.Privileges = Ext.extend(Ext.grid.EditorGridPanel, {
      ...
      var searchFieldBtn = new Ext.Button({
         menu: new Ext.menu.Menu({
            items: [
               ...
               , { checked: false, checkHandler: checkHandler, group: 'filterField', key: 'description', scope: this, text: 'Descripcion' }
	   ...
	   Ext.applyIf(config, {
         ...
         , bbar: new Ext.PagingToolbar({
            displayInfo: true
            , displayMsg: 'Privilegios {0} - {1} of {2}'
            , emptyMsg: 'No existen Privilegios que mostrar'
            , pageSize: 30
            , store: store
         })
         , closable: true
   ...
   , deletePrivilege : function(record){
      Ext.MessageBox.confirm('Confirm', 'Seguro de borrar el registro id: ' + record.data.id + '?', function(btn){
         if(btn === "yes"){
